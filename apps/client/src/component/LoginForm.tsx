...
const LoginSchema = userSchema.omit({ _id: true, name: true }).merge(
  z.object({
...
type Props = {
  onHandleSubmit: SubmitHandler<LoginI>

  isLoading: boolean
}
const LoginForm: FC<Props> = ({ onHandleSubmit, isLoading }) => {
            ...
            <div className="mb-12  mr-4 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12">
              <form onSubmit={handleSubmit(onHandleSubmit)}>
                ...
                <div className="relative mb-10" data-te-input-wrapper-init="">
                  ...
                  {!!errors.password && (
                    <div
                      className="mb-6 absolute w-full text-sm text-red-500 peer-focus:text-red-500 dark:text-neutral-200 dark:peer-focus:text-primary"
                      data-te-input-helper-ref=""
                    >
